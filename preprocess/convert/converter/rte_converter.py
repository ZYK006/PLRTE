...
class RTEConverter:
    def __init__(self, NAN="NAN", template_path='preprocess/template/rte_template.json'):
        ...
        self.relation_int_out_format_en = {
            ...
            1:['{Relation：Subject,Object}', self.relation_convert_target1],
        }
    ...
    def convert(self, record, rand1, rand2, s_schema1="", s_schema2=""):
        ...
        sinstruct = self.relation_template[str(rand1)].format(s_format=output_template[0], s_schema1=s_schema1, s_schema2=s_schema2)
